...
function searchByTags(recipes, searchTerms) {
    ...
    if (searchTerms.length > 2) {
        ...
        for (let i in recipes) {
            arrayFilter = recipes[i].name.toLowerCase().includes(searchTerms) || recipes[i].description.toLowerCase().includes(searchTerms);
            return recipes[i].name.toLowerCase().includes(searchTerms) || recipes[i].description.toLowerCase().includes(searchTerms);
        }
    } else {
